...
struct AppButton: View {
    ...
    var body: some View {
        ...
        .accessibilityHint("双击打开应用并启用 JIT。使用操作转轮管理收藏或复制包名 ID。".localized)
    ...
    private func toggleFavorite() {
        ...
        persistIfChanged()
        AccessibilityAnnouncer.announce(wasFavorite ? "已从收藏中移除".localized : "已添加到收藏".localized)
    }
