        ...
        Task {
            ...
            do {
                ...
                await MainActor.run {
                    ...
                    ddiResultMessage = ("DDI 文件刷新成功。", false)
                }
            } catch {
                await MainActor.run {
                    isRedownloadingDDI = false
                    ddiResultMessage = ("刷新 DDI 文件失败：\(error.localizedDescription)", true)
                }
            }
        }
